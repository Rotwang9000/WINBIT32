...
import {
	...
	WC_SUPPORTED_CHAINS,
} from "@swapkit/wallet-wc/src/constants.ts";
import { getEVMSigner } from "@swapkit/wallet-wc/src/evmSigner.ts";
import { chainToChainId, getAddressByChain } from "@swapkit/wallet-wc/src/helpers.ts";
import { getRequiredNamespaces } from "@swapkit/wallet-wc/src/namespaces.ts";
